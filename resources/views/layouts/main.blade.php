...
<body>
    <div id="app">
                        ...
                        <div aria-labelledby="userInfo" class="dropdown-menu">
                            ...
                            <div class="dropdown-divider"></div>
                                @foreach (auth()->user()->getRoleNames() as $role)
                                    ...
                                    <a href="/admin" class="dropdown-item">Espace administrateur</a><div class="dropdown-divider"></div>
                                    @endif
                                @endforeach
        ...
        <div id="sidebar" class="sidebar py-3">
            ...
            <li class="sidebar-list-item"><a href="{{ route('draft') }}" class="sidebar-link text-muted @if($section == 'draft') active @endif"><span class="col-2 d-flex p-0 mr-3"><i class="fas fa-file m-auto text-gray"></i></span><span id="legend">Brouillions</span></a></li>
